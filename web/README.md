...
- **Schema (run in order):** `supabase/2026-09-01-fleet-management.sql`, then `-fleet-holder-claims.sql`, `-fleet-assigned-pool.sql`, `-fleet-remove-us-material.sql`, then `-fleet-emea-inventory.sql`, and finally `-fleet-roadshow-bookings.sql`.
