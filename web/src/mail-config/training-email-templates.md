...
Use placeholder syntax like `{{PLACEHOLDER}}`.
...
## TEMPLATE_ID: pre_abroad_en

SUBJECT: Training agenda - {{COMPANY_NAME}} - {{TRAINING_DATE}}
...
Please prepare:
* Room/Area for theory and data processing
* Access for the flight area
...
## TEMPLATE_ID: pre_abroad_de

SUBJECT: Trainingsagenda - {{COMPANY_NAME}} - {{TRAINING_DATE}}
...
* Raum/Area für Theorie & Datenauswertung
* Zugang / Freigaben für Übungsbereich
