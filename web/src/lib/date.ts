/** Local-timezone date-key helpers shared by the Time Tracker and Mail
 * Tracking modules. Keys are `YYYY-MM-DD` in the user's local timezone —
 * matching how the tracker stores day logs. */
